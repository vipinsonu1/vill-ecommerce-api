...
var ObjectDataOutput = (function () {
    function ObjectDataOutput(length, service, isBigEndian) {
...
var PositionalObjectDataOutput = (function (_super) {
...
var ObjectDataInput = (function () {
    ...
    ObjectDataInput.prototype.readData = function () {
        ...
        var data = bytes === null ? null : new HeapData_1.HeapData(new Buffer(bytes));
        return data;
    };
